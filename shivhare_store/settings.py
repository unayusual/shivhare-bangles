"""
Django settings for shivhare_store project.
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-key-default-replace-me')
...
ROOT_URLCONF = 'shivhare_store.urls'
...
WSGI_APPLICATION = 'shivhare_store.wsgi.application'
